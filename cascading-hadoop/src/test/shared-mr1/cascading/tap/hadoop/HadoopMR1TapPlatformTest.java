...
public class HadoopMR1TapPlatformTest extends PlatformTestCase implements Serializable
  ...
  public void testFilteredPartitionTap_Typical() throws Exception
    ...
    partitionTap.addFilter(new PartitionFilter(Arrays.asList("2", "4")), new Fields("number"));
  ...
  @Test
  public void testFilteredPartitionTap_SameNameSameTypes() throws Exception
    {
    Fields partitionFields = new Fields("name", String.class);
    Fields argumentSelector = new Fields("name", String.class);
  ...
  public void testFilteredPartitionTap_SameNameDifferentTypes() throws Exception
    {
    Fields partitionFields = new Fields("name", String.class);
    Fields argumentSelector = new Fields("name", Integer.class);
    testFilteredPartitionTapFields(partitionFields, argumentSelector);
    }

  @Test(expected = IllegalArgumentException.class)
  public void testFilteredPartitionTap_DifferentNameNoTypes() throws Exception
    {
  ...
  @Test(expected = IllegalArgumentException.class)
  public void testFilteredPartitionTap_DifferentNameSameTypes() throws Exception
    {
    Fields partitionFields = new Fields("name1", String.class);
    Fields argumentSelector = new Fields("name2", String.class);
    testFilteredPartitionTapFields(partitionFields, argumentSelector);
    }

  @Test(expected = IllegalArgumentException.class)
  public void testFilteredPartitionTap_DifferentNameDifferentTypes() throws Exception
    {
    Fields partitionFields = new Fields("name1", String.class);
    Fields argumentSelector = new Fields("name2", Integer.class);
    testFilteredPartitionTapFields(partitionFields, argumentSelector);
    }
  ...
  private void testFilteredPartitionTapFields(Fields partitionFields, Fields argumentSelector) throws Exception {
    ...
    partitionTap.addFilter(new TrueFilter(), argumentSelector);
  }
